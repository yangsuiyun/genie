...
### 基础操作
1. **Today视图**: 点击侧边栏顶部的 📅 Today 按钮查看今日任务
2. **创建项目**: 点击侧边栏项目标题右侧的 ➕ 按钮
3. **选择项目**: 点击侧边栏中的项目名称，自动显示该项目的任务
4. **添加任务**: 点击右上角的 ➕ 按钮（仅在任务页面显示）
5. **设置截止日期**: 创建/编辑任务时选择截止日期，任务卡片会显示智能标签
6. **管理已完成任务**: 点击眼睛图标切换已完成任务的显示/隐藏
7. **查看历史任务**: 使用"加载更多"按钮查看更多已完成任务
8. **编辑任务**: 点击任务卡片右上角的 ⋮ 菜单按钮
9. **拖拽排序**: 长按项目或任务卡片拖拽到新位置
10. **开始番茄钟**: 点击任务卡片上的 ▶️ 播放按钮
11. **查看统计**: 点击侧边栏的 📊 统计按钮
12. **配置设置**: 点击侧边栏的 ⚙️ 设置按钮
...
### v2.2.0 - 任务管理增强版本
- 📅 **Today视图**: 新增Today按钮，智能筛选今日相关任务
- 📅 **截止日期管理**: 任务卡片显示截止日期，智能颜色编码紧急程度
- 👁️ **已完成任务管理**: 折叠/展开已完成任务，保持界面整洁
- 📄 **分页加载**: 历史任务分页加载，每次加载10条，提升性能
- 🎨 **界面优化**: 侧边栏宽度扩展至250px，Today按钮位置优化
- 🔧 **技术改进**: 修复ConsumerState构建方法，优化代码结构
- 📱 **用户体验**: 更直观的任务管理流程，提高工作效率
